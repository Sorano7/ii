...
func createLexer(src string) *lexer {
	return &lexer{
		...
		patterns: []pattern{
			...
			{regexp.MustCompile(`<>`), defaultHandler(Diamond)},
			{regexp.MustCompile(`>>`), defaultHandler(RPipe)},
			{regexp.MustCompile(`<<`), defaultHandler(LPipe)},
			{regexp.MustCompile(`=`), defaultHandler(Equals)},
			{regexp.MustCompile(`!=`), defaultHandler(NotEquals)},
			{regexp.MustCompile(`\|`), defaultHandler(Bar)},
